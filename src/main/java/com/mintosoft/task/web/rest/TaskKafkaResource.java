...
@RestController
@RequestMapping("/api/task-kafka")
public class TaskKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TaskKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TaskKafkaResource(KafkaProperties kafkaProperties) {
